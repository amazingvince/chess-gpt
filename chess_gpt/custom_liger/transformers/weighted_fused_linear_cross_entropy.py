...
class WeightedLigerFusedLinearCrossEntropyLoss(torch.nn.Module):
    def __init__(
        self,
    ...
    def forward(self, lin_weight, _input, target, sample_weights=None, bias=None):
        return WeightedLigerFusedLinearCrossEntropyFunction.apply(
            _input,
            lin_weight,
            target,
            sample_weights,
